...
class ContaLuzSyncService:
    ...
    def sync_from_pdfs(self, pdf_paths: Sequence[str]) -> dict:
        ...
        _logger.debug("Existing references loaded", extra={"existing_count": len(referencias_existentes)})
        ...
        for caminho_pdf in pdf_paths:
            try:
                ...
                # Qualquer falha de extração (ex.: tabela não encontrada) faz pular o arquivo
